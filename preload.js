...
console.log("Preload: Yüklendi");

contextBridge.exposeInMainWorld('electronAPI', {
  startCRN: (data) => {
    console.log("Preload: start-crn gönderiliyor", data);
  ...
  loadConfig: () => {
    console.log("Preload: load-config gönderiliyor");
  ...
  saveConfig: (configData) => {
    console.log("Preload: save-config gönderiliyor", configData);
